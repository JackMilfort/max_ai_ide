...
export function shortcutsPopupHTML() {
  return `
      <div id="ge-shortcuts-handle" style="display:flex;align-items:center;gap:6px;margin:-4px -6px 4px;padding:4px 6px;cursor:grab;user-select:none;touch-action:none;">
        ...
        <strong style="font-size:12px;letter-spacing:0.3px;">Editaror Shortcuts</strong>
      ...
      <div class="ge-shortcuts-grid">
        ...
        <div class="ge-shortcuts-col">
          ...
          <div><kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>S</kbd> Guardar to Galería</div>
        ...
        <div class="ge-shortcuts-col">
          ...
          <div><kbd>Ctrl</kbd>+<kbd>C</kbd> Copiar to layer</div>
          <div><kbd>Ctrl</kbd>+<kbd>X</kbd> Cut lasso</div>
          <div><kbd>Ctrl</kbd>+<kbd>D</kbd> Eliminar pixels</div>
          <div><kbd>Esc</kbd> Cancelar selection / crop</div>
        </div>
        <div class="ge-shortcuts-col">
          <h5>Brush / Mask</h5>
 ...
 * hide and wires the Cancelar / Crear buttons).
 */
