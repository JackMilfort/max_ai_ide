...
;t+=A.substring(e),S.addText(t)}function d(){null!=x.subIdioma?(()=>{
if(""===A)return;let e=null;if("string"==typeof x.subIdioma){
if(!a[x.subIdioma])return void S.addText(A)
;e=f(x.subIdioma,A,!0,M[x.subIdioma]),M[x.subIdioma]=e._top
}else e=E(A,x.subIdioma.length?x.subIdioma:null)
...
x.scope&&S.closeNode(),x.skip||x.subIdioma||(C+=x.relevance),x=x.parent
...
},registerIdioma:(e,n)=>{let i=null;try{i=n(t)}catch(n){
if(K("Idioma definition for '{}' could not be registered.".replace("{}",e)),
!s)throw n;K(n),i=c}
i.name||(i.name=e),a[e]=i,i.rawDefinition=n.bind(null,t),i.aliases&&O(i.aliases,{
languageName:e})},unregisterIdioma:e=>{delete a[e]
;for(const n of Object.keys(i))i[n]===e&&delete i[n]},
listIdiomas:()=>Object.keys(a),getIdioma:v,registerAliases:O,
...
const _e="[A-Za-z$_][0-9A-Za-z$_]*",he=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],fe=["true","false","null","undefined","NaN","Infinity"],Ee=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","CompartirdArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],ye=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],Ne=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],we=["arguments","this","super","console","window","document","localStorage","sessionStorage","module","global"],ve=[].concat(Ne,Ee,ye)
...
returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,c],subIdioma:"xml"}},g={
begin:"css`",end:"",starts:{end:"`",returnEnd:!1,
contains:[e.BACKSLASH_ESCAPE,c],subIdioma:"css"}},u={begin:"gql`",end:"",
starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,c],
subIdioma:"graphql"}},b={className:"string",begin:"`",end:"`",
...
"on:begin":a.isTrulyOpeningTag,end:a.end}],subIdioma:"xml",contains:[{
...
const n={begin:/<\/?[A-Za-z_]/,end:">",subIdioma:"xml",relevance:0},t={
...
subIdioma:"mojolicious",contains:[{begin:"^@@.*",end:"$",className:"comment"}]
...
},grmr_php_template:e=>({name:"PHP template",subIdioma:"xml",contains:[{
begin:/<\?(php|=)?/,end:/\?>/,subIdioma:"php",contains:[{begin:"/\\*",
...
starts:{end:/ |$/,starts:{end:"$",subIdioma:"python"}},variants:[{
...
},a="([ui](8|16|32|64|128|size)|f(32|64))?",i=["drop ","Copiar","Send","Sized","Sync","Drop","Fn","FnMut","FnOnce","ToOwned","Clone","Debug","PartialEq","PartialOrd","Eq","Ord","AsRef","AsMut","Into","From","Default","Iterator","Extend","IntoIterator","DoubleEndedIterator","ExactSizeIterator","SliceConcatExt","ToString","assert!","assert_eq!","bitflags!","bytes!","cfg!","col!","concat!","concat_idents!","debug_assert!","debug_assert_eq!","env!","eprintln!","panic!","file!","format!","format_args!","include_bytes!","include_str!","line!","local_data_key!","module_path!","option_env!","print!","println!","select!","stringify!","try!","unimplemented!","unreachable!","vec!","write!","writeln!","macro_rules!","assert_ne!","debug_assert_ne!"],r=["i8","i16","i32","i64","i128","isize","u8","u16","u32","u64","u128","usize","f32","f64","str","char","bool","Box","Option","Result","String","Vec"]
...
end:/<\/style>/,returnEnd:!0,subIdioma:["css","xml"]}},{className:"tag",
begin:/<script(?=\s|>)/,end:/>/,keywords:{name:"script"},contains:[l],starts:{
end:/<\/script>/,returnEnd:!0,subIdioma:["javascript","handlebars","xml"]}},{
...
begin:"[\\|>]([1-9]?[+-])?[ ]*\\n( +)[^ ][^\\n]*\\n(\\2[^\\n]+\\n?)*"},{
begin:"<%[%=-]?",end:"[%-]?%>",subIdioma:"ruby",excludeBegin:!0,excludeEnd:!0,
...
const n=e.replace("grmr_","").replace("_","-");He.registerIdioma(n,Ke[e])}
return He}()
